...
def fetch_user_rating(key: str, id: str) -> str:
...
def output_ratings(key, data_dict):
    with open("titles.txt", 'w') as f:
        ...
        f.write(WoT["title"] + " - Rating: " + fetch_user_rating(key, WoT["id"]) + '\n')
        f.write(data_dict[1]["title"] + " - Rating: " + fetch_user_rating(key, data_dict[1]["id"]) + '\n')
        f.write(data_dict[50]["title"] + " - Rating: " + fetch_user_rating(key, data_dict[50]["id"]) + '\n')
        f.write(data_dict[100]["title"] + " - Rating: " + fetch_user_rating(key, data_dict[100]["id"]) + '\n')
        f.write(data_dict[150]["title"] + " - Rating: " + fetch_user_rating(key, data_dict[150]["id"]) + '\n')
        f.write(data_dict[200]["title"] + " - Rating: " + fetch_user_rating(key, data_dict[200]["id"]) + '\n')
        f.write(data_dict[250]["title"] + " - Rating: " + fetch_user_rating(key, data_dict[250]["id"]) + '\n')
